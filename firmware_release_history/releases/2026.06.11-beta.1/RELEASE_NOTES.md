...
This beta addressed validation testing where accuracy improved late in a run, but coarse handoff moved progressively earlier and micro recovery became slower. It preserved existing characterization and machine calibration data.
...
- OTA staging, apply, and post-reboot version checks passed in beta testing.
...
- The beta baseline contained one genuine fast-fine outlier. The new estimator reacts without permanently adopting the maximum, but this remained high priority to watch.
